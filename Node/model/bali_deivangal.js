...
const baliDeivangalSchema = Joi.object({
...
const BaliDeivangalController = (function () {

  const _createBaliDeivangal = async (jsonValue, callback) => {
    const { error, value } = baliDeivangalSchema.validate(jsonValue);
      ...
      getConnectionWsinventoryPool(async (err, client) => {
        ...
        `;
          ...
          callback(null, {
            ...
            code: 200,
            message: "Bali Deivangal created successfully",
  ...
  const _getBaliDeivangal = async (callback) => {
    try {
      getConnectionWsinventoryPool(async (err, client) => {
        if (err) return callback({ result: result_failure, code: 500, message: "Database connection error" }, null);
  ...
  const _getBaliDeivangalById = async (id, callback) => {
    try {
      getConnectionWsinventoryPool(async (err, client) => {
        if (err) return callback({ result: result_failure, code: 500, message: "Database connection error" }, null);
        ...
        try {
          ...
          if (rows.length === 0) return callback({ result: result_failure, code: 404, message: "Bali Deivangal not found" }, null);
  ...
  const _getBaliDeivangalByTempleId = async (temple_id, callback) => {
    try {
      getConnectionWsinventoryPool(async (err, client) => {
        if (err) return callback({ result: result_failure, code: 500, message: "Database connection error" }, null);
  ...
  const _updateBaliDeivangal = async (jsonValue, callback) => {
    const { error, value } = baliDeivangalSchema.validate(jsonValue);
    ...
    try {
      getConnectionWsinventoryPool(async (err, client) => {
        ...
        try {
          const checkQuery = `SELECT id FROM bali_deivangal WHERE id = ?`;
          const [checkResult] = await client.query(checkQuery, [value.id]);
          if (checkResult.length === 0) return callback({ result: result_failure, code: 404, message: "Bali Deivangal not found" }, null);

          const updateQuery = `
            UPDATE bali_deivangal
          ...
          callback(null, { result: result_success, code: 200, message: "Bali Deivangal updated successfully" });
        } catch (queryError) {
          callback({ result: result_failure, code: 400, message: queryError.message }, null);
        } finally {
          client.release();
  ...
  const _deleteBaliDeivangal = async (jsonValue, callback) => {
    ...
    try {
      getConnectionWsinventoryPool(async (err, client) => {
        ...
        try {
          ...
          const deleteQuery = `DELETE FROM bali_deivangal WHERE id = ?`;
          await client.query(deleteQuery, [value.id]);

          callback(null, { result: result_success, code: 200, message: "Bali Deivangal deleted successfully" });
        } catch (queryError) {
          callback({ result: result_failure, code: 400, message: queryError.message }, null);
        } finally {
          client.release();
  ...
  return {
    CreateBaliDeivangal: _createBaliDeivangal,
    GetBaliDeivangal: _getBaliDeivangal,
    GetBaliDeivangalById: _getBaliDeivangalById,
    GetBaliDeivangalByTempleId: _getBaliDeivangalByTempleId,
    UpdateBaliDeivangal: _updateBaliDeivangal,
    DeleteBaliDeivangal: _deleteBaliDeivangal,
  };
})();

module.exports = BaliDeivangalController;
