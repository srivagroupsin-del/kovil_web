...
const kavalDeivangalSchema = Joi.object({
...
const KavalDeivangalController = (function () {

  const _createKavalDeivangal = async (jsonValue, callback) => {
    const { error, value } = kavalDeivangalSchema.validate(jsonValue);
    ...
    try {
      getConnectionWsinventoryPool(async (err, client) => {
        ...
        try {
          const insertQuery = `
          INSERT INTO kaval_deivangal
          (created_date, deity_speciality, deivam_type, fastings, name, notes, photo, prayer_request, relationship, relationship_status, separate_sannidhi, special_days, special_name, special_puja, status, updated_date, worship_method, temple_id)
          VALUES
          (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)
        `;
          ...
          callback(null, {
            ...
            code: 200,
            message: "Kaval Deivangal created successfully",
  ...
  const _getKavalDeivangal = async (callback) => {
    try {
      getConnectionWsinventoryPool(async (err, client) => {
        if (err) return callback({ result: result_failure, code: 500, message: "Database connection error" }, null);
        ...
        try {
          const query = `
            SELECT id, created_date, deity_speciality, deivam_type, fastings, name, notes, photo, prayer_request, relationship, relationship_status, separate_sannidhi, special_days, special_name, special_puja, status, updated_date, worship_method, temple_id
            FROM kaval_deivangal
            ORDER BY id DESC;
          `;
  ...
  const _getKavalDeivangalById = async (id, callback) => {
    try {
      getConnectionWsinventoryPool(async (err, client) => {
        if (err) return callback({ result: result_failure, code: 500, message: "Database connection error" }, null);
        ...
        try {
          ...
          if (rows.length === 0) return callback({ result: result_failure, code: 404, message: "Kaval Deivangal not found" }, null);
  ...
  const _getKavalDeivangalByTempleId = async (temple_id, callback) => {
    try {
      getConnectionWsinventoryPool(async (err, client) => {
        if (err) return callback({ result: result_failure, code: 500, message: "Database connection error" }, null);
  ...
  const _updateKavalDeivangal = async (jsonValue, callback) => {
    const { error, value } = kavalDeivangalSchema.validate(jsonValue);
    ...
    try {
      getConnectionWsinventoryPool(async (err, client) => {
        ...
        try {
          const checkQuery = `SELECT id FROM kaval_deivangal WHERE id = ?`;
          const [checkResult] = await client.query(checkQuery, [value.id]);
          if (checkResult.length === 0) return callback({ result: result_failure, code: 404, message: "Kaval Deivangal not found" }, null);

          const updateQuery = `
            UPDATE kaval_deivangal
          ...
          callback(null, { result: result_success, code: 200, message: "Kaval Deivangal updated successfully" });
        } catch (queryError) {
          callback({ result: result_failure, code: 400, message: queryError.message }, null);
        } finally {
          client.release();
  ...
  const _deleteKavalDeivangal = async (jsonValue, callback) => {
    ...
    try {
      getConnectionWsinventoryPool(async (err, client) => {
        ...
        try {
          ...
          const deleteQuery = `DELETE FROM kaval_deivangal WHERE id = ?`;
          await client.query(deleteQuery, [value.id]);

          callback(null, { result: result_success, code: 200, message: "Kaval Deivangal deleted successfully" });
        } catch (queryError) {
          callback({ result: result_failure, code: 400, message: queryError.message }, null);
        } finally {
          client.release();
  ...
  return {
    CreateKavalDeivangal: _createKavalDeivangal,
    GetKavalDeivangal: _getKavalDeivangal,
    GetKavalDeivangalById: _getKavalDeivangalById,
    GetKavalDeivangalByTempleId: _getKavalDeivangalByTempleId,
    UpdateKavalDeivangal: _updateKavalDeivangal,
    DeleteKavalDeivangal: _deleteKavalDeivangal,
  };
})();

module.exports = KavalDeivangalController;
